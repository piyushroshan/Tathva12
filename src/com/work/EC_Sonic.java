...
public class EC_Sonic extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ec_sonic);

	        TabHost tabs = (TabHost)findViewById(R.id.tabhost_ec_sonic);
	        ...
	        spec4.setContent(R.id.linear_ec_sonic_specs);
	        ...
	        spec3.setContent(R.id.linear_ec_sonic_contact);
